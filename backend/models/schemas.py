...
class AgentOutput(BaseModel):
    """Momo Agent 输出"""
    reply: str = Field(..., description="小桃的对话回复")
...
class AppSettings(BaseModel):
    ...
    context: dict = Field(default_factory=lambda: {"max_tokens": 8000, "compress_at": 0.7})
    ...
    memory: dict = Field(default_factory=lambda: {"condensation_time": "02:00", "condensation_days": 1, "retention_days": 30})
